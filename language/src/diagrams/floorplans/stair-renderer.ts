...
import type { Floor, Stair, Lift, StairShape, LShapedStair, UShapedStair, DoubleLStair, SpiralStair, CurvedStair, WinderStair, SegmentedStair } from "../../generated/ast.js";
import { 
...
function generateLShapedStairSvg(
    ...
    // Coordinates
    let l1x=0, l1y=0, l1w=0, l1h=0; // Leg 1
    let lx=0, ly=0, lw=landingW, lh=landingH; // Landing
    let l2x=0, l2y=0, l2w=0, l2h=0; // Leg 2
