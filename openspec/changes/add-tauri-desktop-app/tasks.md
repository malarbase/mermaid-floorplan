...
- [ ] 1.3 Configure `tauri.conf.json` to point to `interactive-editor/dist`
...
- [ ] 10.1 Full workflow test: create, edit, save, reopen
- [ ] 10.2 Test with complex multi-floor floorplan
- [ ] 10.3 Verify bundle size meets target (<15MB)
- [ ] 10.4 Verify startup time meets target (<2s)
- [ ] 10.5 Create and test release installers
