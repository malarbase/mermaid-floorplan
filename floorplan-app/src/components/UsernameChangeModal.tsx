...
export function UsernameChangeModal(props: UsernameChangeModalProps) {
  ...
  return (
    <Modal
      isOpen={props.isOpen}
      onClose={() => !isSubmitting() && props.onClose()}
      title={step() === 'select' ? 'Change Username' : 'Confirm Username Change'}
      error={error()}
    >
      ...
      <Show when={step() === 'select'}>
        ...
        <p class="py-4 text-base-content/70">
          ...
          >
            ...
            <span class="font-bold">{cooldown()!.currentReservationDays} days</span> (only you can
            reclaim it).
          </Show>
        </p>
          ...
          <Show when={isUndoTarget()}>
            <div class="alert alert-success mb-4">
              ...
              <div>
                ...
                <p class="text-sm">This is a free undo and won't affect your change cooldown.</p>
              </div>
            </div>
          </Show>
            ...
            <div class="text-sm space-y-2">
              ...
              <Show when={!isUndoTarget()}>
                <div class="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    <span class="font-bold">{cooldown()?.currentReservationDays ?? 90} days</span> —
              ...
              <Show when={!isUndoTarget() && (cooldown()?.recentChangeCount ?? 0) > 0}>
                <div class="flex items-start gap-2">
                  ...
                  <span>
                    Your next username change will require a longer wait (cooldown increases with
                    each change)
                  </span>
                </div>
              </Show>
