        ...
        <li>
          ...
          >
            ...
            <div class="text-left">
              ...
              <div class="text-xs text-base-content/60">Only you and collaborators can view</div>
            </div>
          </button>
        </li>
        <li>
          ...
          >
            ...
            <div class="text-left">
              ...
              <div class="text-xs text-base-content/60">Anyone with the link can view</div>
            </div>
          </button>
        </li>
      </ul>
