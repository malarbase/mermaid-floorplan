          ...
          <table class="table w-full">
            ...
            <tbody>
              ...
              <Show when={!users.isLoading() && users.data()?.length === 0}>
                <tr>
                  <td colspan={isSuperAdmin() ? 6 : 4} class="text-center py-12 text-base-content/50">
                ...
                {(user) => (
                  <tr class="hover:bg-base-200/30 transition-colors">
                    ...
                    <td>
                      ...
                      >
                        <span class={`badge badge-sm ${user.isSuperAdmin ? "badge-primary" : "badge-secondary"}`}>
                    ...
                    <Show when={isSuperAdmin()}>
                      <td class="text-right">
                        <div class="flex justify-end gap-2">
                          ...
                          {user.isAdmin && user._id !== currentUser.data()?._id && !user.isSuperAdmin && (
                            <button 
