    ...
    <main class="min-h-screen app-container">
      ...
      <div class="hero min-h-screen px-4 pt-24 pb-12 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div class="text-center lg:text-left">
            <h1
              class="text-5xl sm:text-6xl md:text-8xl tracking-wide leading-none mb-6"
            ...
            <p
              class="py-6 text-lg sm:text-xl text-base-content/70 max-w-xl mx-auto lg:mx-0 leading-relaxed"
              style={{ 'font-family': "'DM Sans', sans-serif" }}
            >
              Create, visualize, and share architectural floorplans with our intuitive DSL-powered
              3D designer. Write simple text, see stunning results.
            </p>
      ...
      <section class="py-16 sm:py-24 px-4 relative" id="demo">
        <div class="max-w-6xl mx-auto">
          <h2
            class="text-3xl sm:text-4xl text-center mb-12 sm:mb-16 tracking-wide"
            style={{ 'font-family': "'Bebas Neue', sans-serif" }}
          >
            POWERFUL FEATURES
          </h2>
          ...
          <div class="grid gap-6 md:gap-8 md:grid-cols-3">
            <div class="project-card border border-neutral shadow-sm p-6 sm:p-8 card-hover">
              ...
              <p class="text-base-content/60">
                Write floorplans using an intuitive domain-specific language. No complex CAD
                software needed.
              </p>
            </div>
            ...
            <div class="project-card border border-neutral shadow-sm p-6 sm:p-8 card-hover">
              ...
              <p class="text-base-content/60">
                See your designs come to life with real-time 3D rendering. Explore from any angle.
              </p>
            </div>
            ...
            <div class="project-card border border-neutral shadow-sm p-6 sm:p-8 card-hover">
              ...
              <p class="text-base-content/60">
                Save your projects to the cloud. Share with clients or collaborate with your team.
              </p>
            </div>
          </div>
        </div>
      ...
      <section class="py-16 sm:py-24 px-4 relative bg-base-200">
        <div class="max-w-4xl mx-auto text-center">
          <h2
            class="text-3xl sm:text-4xl mb-4 tracking-wide"
            style={{ 'font-family': "'Bebas Neue', sans-serif" }}
          >
            READY TO DESIGN YOUR SPACE?
          </h2>
          <p
            class="mb-8 text-base-content/60 max-w-xl mx-auto"
            style={{ 'font-family': "'DM Sans', sans-serif" }}
          >
