      ...
      <div class="p-8">
        <div class="max-w-3xl mx-auto">
          ...
          <p class="text-base-content/70 mb-6">
            Floorplan is a powerful tool for designing and visualizing architectural 
            floorplans using an intuitive domain-specific language (DSL).
          </p>
          ...
          <div class="card bg-base-100 shadow-xl">
            <div class="card-body">
              ...
              <p class="text-base-content/70">
                Built with SolidStart, Three.js, and Convex for a modern, 
